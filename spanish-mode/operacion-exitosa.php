...
<html lang="es-Ar">
  ...
  <body>
    ...
    <section class="containerExitoso">
      <div class="container">
        <div class="row">
          <div class="col">
            <img src="assets/images/castex-logo-mini.png" alt="">
            <h2>MUCHAS GRACIAS POR CONTACTARNOS</h2>
            <h3>
              A la brevedad nos pondremos en contacto para finalizar tu pedido
              <br>
              Mientras tanto podes seguirnos en nuestras redes sociales:
            </h3>
              <p class="redes">
